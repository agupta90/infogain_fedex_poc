...
            Transaction History
          </Typography>
          <a href="/"><StyledBadge badgeContent={423} color="primary" className="MuiBadge-badge"/></a>
          <span className="title-right">Welcome, Right</span>
        </Toolbar>
      </AppBar>
    </div>
  );
...
class TransactionsHistory extends React.Component {
    ...
    render(){
        return(          
            <React.Fragment>
                <PrimarySearchAppBar/>
                {/* <Rewards userId = {this.props.userId} 
